	 ...
	 var controller = new ScrollMagic.Controller();
	   ...
	   //Skills animation
		...
		$('.service').each(function(){
			...
			var serviceStager = TweenMax.staggerFrom('.stagger', 0.5, {opacity:0, y:200, delay:0.5},0.2);
		...
		$('.contact').each(function(){
						...
						var serviceStager2 = TweenMax.staggerFrom('.stagger2', 0.5, {opacity:0, y:200, delay:0.5},0.2);
